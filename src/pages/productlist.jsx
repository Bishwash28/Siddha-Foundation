...
//           // Link changes the URL from '/' to '/product/1', '/product/2', etc.
//           <Link
//             key={product.id}
...
//               <div className="bg-[#fcfbf7] h-48 flex items-center justify-center p-4">
//                 <img
//                   src={product.image}
//                   alt={product.title}
...
//                   </span>
//                   <span className="bg-[#6e9e54] text-white text-xs font-semibold px-2 py-1 rounded-sm">
//                     {product.bundleTag}
//                   </span>
//                 </div>
//               </div>
