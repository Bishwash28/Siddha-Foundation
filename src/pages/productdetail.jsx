...
//   // min-h-[380px] ensures vertical consistency and prevents internal cut-off
//   <Link
//     to={`/product/${product.id}`}
//     // className="border border-gray-200 rounded-lg p-3 flex flex-col items-center text-center hover:shadow-lg transition duration-300 min-h-[380px]"
//     className="h-full border border-gray-200 rounded-lg p-3 flex flex-col items-center text-center hover:shadow-lg transition duration-300"
//   >
...
//     {/* Description/Features Snippet: Enforce consistent height */}
//     <p className="text-xs text-gray-500 mt-1 mb-3 h-8 overflow-hidden line-clamp-2">
//       {product.features[0].substring(0, 50)}
//       {product.features[0].length > 50 ? "..." : ""}
//     </p>

//     {/* Price display: flex-grow ensures this pushes down the button */}
...
//     {/* Action Button: mt-auto pushes the button to the bottom of the card */}
...
//   // Logic: Exclude the current product and take the next 4 items for display.
...
//   return (
//     <div className="mt-12 pt-6 border-t border-gray-200 w-full max-w-[1100px] px-6 md:px-0">
//       <h2 className="text-2xl font-bold text-gray-900 text-center mb-1 uppercase tracking-wider">
//         Related Products
//       </h2>
...
//   return (
//     // KEY FIX: Added pb-32 to the main container to ensure ample padding at the bottom.
...
//       {/* --- MAIN PRODUCT DETAIL CARD (Unmodified) --- */}
//       <div className="bg-white rounded-lg shadow-xl max-w-[1100px] w-full grid grid-cols-1 md:grid-cols-2 overflow-hidden mt-0 md:mt-4">
